...
$('#inputAnio').tokenfield({
    typeahead: [null, {
        source: anio.ttAdapter(),
        displayKey: 'value' }]
});
...
$('#inputLugarencontrado').tokenfield({
    typeahead: [null, {
